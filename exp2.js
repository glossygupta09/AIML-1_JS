let employees = [];
        ...
        function totalSalary() {
            ...
            document.getElementById("result").innerHTML = `Total Salary of all Employees: ₹${total}`;
        }

        function averageSalary() {

            if (employees.length === 0) {
                document.getElementById("result").innerHTML = "No employees to calculate average salary.";
                return;
            }
            let average = employees.reduce((sum, emp) => sum + emp.salary, 0) / employees.length;
            document.getElementById("result").innerHTML = `Average Salary of all Employees: ₹${average.toFixed(2)}`;
        }
        ...
        function countByDepartment() {
            ...
            document.getElementById("result").innerHTML = `Number of Employees in ${deptName} Department: ${count}`;
        }
